#!/usr/bin/env python3
"""Decorators for parameterizing and patching."""
...
class TestGithubOrgClient(unittest.TestCase):
    """Tests for GithubOrgClient functionality"""
    ...
    def test_org(self, org_name, mock):
        """Test if TestGithubOrgClient.org returns the correct value"""
        test_class = GithubOrgClient(org_name)
        test_class.org()
        mock.called_with_once(test_class.ORG_URL.format(org=org_name))

    def test_public_repos_url(self):
        """Test if TestGithubOrgClient.public_repos_url
    ...
    def test_public_repos(self, mock_json):
        """Test if TestGithubOrgClient.public_repos
        returns value"""
    ...
    def test_has_license(self, repo, license_key, expected):
        """Test if TestGithubOrgClient.has_license is functioning correctly."""
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repo(self):
        """Integration Test for public_repo"""
